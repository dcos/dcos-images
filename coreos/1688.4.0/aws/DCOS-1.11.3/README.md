...
* [aws/dcos_images.json](aws/dcos_images.json) is the DC/OS Cloud Image AMI for the Base Operating System, Core OS 1688.4.0. This has the pre-requisites installed, and can be used directly with provisioners like terraform.
